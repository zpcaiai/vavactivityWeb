...
<style scoped>
.safety-center{max-width:1120px;margin:0 auto;padding:3rem 1.25rem 5rem}.eyebrow{letter-spacing:.14em;color:var(--vav-color-danger)}.intro{max-width:820px}.grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(310px,1fr));gap:1rem}.panel{display:grid;gap:.8rem;padding:1.25rem;border:1px solid var(--vav-color-border);border-radius:18px;background:var(--vav-color-surface-raised)}.support{margin:1rem 0;background:var(--vav-color-surface-warning)}.panel label{display:grid;gap:.35rem}.check{display:flex!important;align-items:center;gap:.5rem}input,select,textarea{padding:.7rem;border:1px solid var(--vav-color-border-strong);border-radius:10px}textarea{min-height:100px}button,.button{justify-self:start;padding:.7rem 1rem;border:0;border-radius:999px;background:var(--vav-color-danger);color:white;text-decoration:none}.secondary{background:var(--vav-color-text-muted)}ul{display:grid;gap:.75rem;padding:0;list-style:none}li{display:flex;justify-content:space-between;gap:1rem;padding-bottom:.65rem;border-bottom:1px solid var(--vav-color-surface-sunken)}li div{display:grid}pre{max-height:220px;overflow:auto;padding:.75rem;background:var(--vav-color-surface-soft)}.alert{padding:.8rem;border-radius:10px}.error{background:var(--vav-color-surface-danger)}.notice{background:var(--vav-color-surface-success)}
</style>
