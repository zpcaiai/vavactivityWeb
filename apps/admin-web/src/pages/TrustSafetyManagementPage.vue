...
<style scoped>
.safety-admin{display:grid;gap:1rem}header{display:flex;justify-content:space-between;gap:2rem;align-items:end}header>p{max-width:660px}.eyebrow{letter-spacing:.12em;color:#8c3c35}nav{display:flex;gap:.55rem;flex-wrap:wrap}nav a{padding:.5rem .8rem;border-radius:999px;background:#f4ece8;color:#333;text-decoration:none}.panel{padding:1rem;border:1px solid #e1d8d2;border-radius:12px;background:#fff}table{width:100%;border-collapse:collapse}th,td{text-align:left;padding:.75rem;border-bottom:1px solid #eee}button{padding:.6rem .85rem;border:0;border-radius:999px;background:#8c3c35;color:white}.alert{padding:.8rem}.error{background:#fde8e7}.notice{background:#e8f5ed}@media(max-width:700px){header{align-items:start;flex-direction:column}table{display:block;overflow:auto}}
</style>
