...
<style scoped>
.quality-console{display:grid;gap:1rem}header{display:flex;justify-content:space-between;gap:2rem;align-items:end}header>div>p{max-width:720px}.eyebrow{letter-spacing:.12em;color:#24535b}.fail-closed{padding:.6rem .8rem;border-radius:8px;background:#7a1f1f;color:#fff}nav{display:flex;gap:.5rem;flex-wrap:wrap}nav a{padding:.5rem .8rem;border-radius:999px;background:#eaf1f1;color:#263d40;text-decoration:none}.metrics{display:grid;grid-template-columns:repeat(auto-fit,minmax(145px,1fr));gap:1rem}.metrics div,.panel{padding:1rem;border:1px solid #d8e1e1;border-radius:12px;background:#fff}.metrics div{display:grid;gap:.35rem}.metrics strong{font-size:1.7rem}.panel{overflow:auto}table{width:100%;border-collapse:collapse}th,td{text-align:left;padding:.65rem;border-bottom:1px solid #edf0f0;vertical-align:top}td code{display:block;max-width:540px;max-height:8rem;overflow:auto;white-space:pre-wrap;overflow-wrap:anywhere}.actions{display:flex;gap:.4rem;flex-wrap:wrap}button{padding:.5rem .75rem;border:0;border-radius:999px;background:#24535b;color:#fff}button:disabled{opacity:.45}.alert{padding:.8rem}.error{background:#fde8e7}.notice{background:#e8f5ed}@media(max-width:700px){header{align-items:start;flex-direction:column}}
</style>
