...
<style scoped>
.membership-admin{display:grid;gap:1rem}header{display:flex;justify-content:space-between;gap:2rem;align-items:end}header>p{max-width:620px}.eyebrow{letter-spacing:.12em;color:var(--vav-color-accent)}nav{display:flex;gap:.55rem;flex-wrap:wrap}nav a{padding:.5rem .8rem;border-radius:999px;background:var(--vav-color-surface-soft);color:var(--vav-color-text);text-decoration:none}.metrics{display:grid;grid-template-columns:repeat(auto-fit,minmax(180px,1fr));gap:1rem}.metrics article,.panel{padding:1rem;border:1px solid var(--vav-color-border);border-radius:12px;background:white}.metrics strong{display:block;margin-top:.5rem;overflow-wrap:anywhere}.editor{display:flex;gap:.6rem;align-items:end;flex-wrap:wrap;padding:1rem;background:var(--vav-color-surface-soft)}.editor h2{width:100%}input{padding:.65rem;border:1px solid var(--vav-color-border-strong);border-radius:8px}button{padding:.65rem .9rem;border:0;border-radius:999px;background:var(--vav-color-success);color:white}table{width:100%;border-collapse:collapse}th,td{text-align:left;padding:.75rem;border-bottom:1px solid var(--vav-color-surface-sunken)}.alert{padding:.8rem}.error{background:var(--vav-color-surface-danger)}.notice{background:var(--vav-color-surface-success)}@media(max-width:700px){header{align-items:start;flex-direction:column}table{display:block;overflow:auto}}
</style>
