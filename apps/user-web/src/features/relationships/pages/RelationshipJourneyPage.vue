...
<style scoped>
.journey-page{max-width:1120px;margin:0 auto;padding:3rem 1.25rem 5rem}.eyebrow{letter-spacing:.14em;color:var(--vav-color-accent)}.intro{max-width:760px;color:var(--vav-color-text-muted)}.cards,.grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:1rem}.card,.panel{display:flex;flex-direction:column;gap:.75rem;padding:1.25rem;border:1px solid var(--vav-color-border);border-radius:18px;background:var(--vav-color-surface-raised);color:inherit;text-decoration:none}.hero{margin:1.25rem 0;background:var(--vav-color-surface-soft)}.row,.actions{display:flex;gap:.65rem;align-items:center;flex-wrap:wrap}.row{padding:.65rem 0;border-top:1px solid var(--vav-color-surface-sunken)}textarea,input,select{box-sizing:border-box;width:100%;padding:.75rem;border:1px solid var(--vav-color-border-strong);border-radius:10px;font:inherit}button{padding:.7rem 1rem;border:0;border-radius:999px;background:var(--vav-color-success);color:var(--vav-color-surface-raised);cursor:pointer}.quiet{background:var(--vav-color-text-muted)}.danger{background:var(--vav-color-danger)}.alert{padding:.8rem;border-radius:10px}.error{background:var(--vav-color-surface-danger)}.notice{background:var(--vav-color-surface-success)}.reflection{padding:.75rem;background:var(--vav-color-surface-soft);border-radius:10px}ol{display:grid;gap:.75rem}li{display:flex;justify-content:space-between;gap:1rem}
</style>
